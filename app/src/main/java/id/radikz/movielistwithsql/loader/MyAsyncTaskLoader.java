...
public class MyAsyncTaskLoader extends AsyncTaskLoader<ArrayList<Movie>> {
    ...
    public MyAsyncTaskLoader(final Context context, String lang) {
        super(context);
    ...
    public ArrayList<Movie> loadInBackground() {
        ...
        String url = "http://api.themoviedb.org/3/discover/movie?api_key=" + API_KEY +"&language="+lang;
